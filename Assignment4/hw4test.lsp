...
;
; Code at most one in CNF by requiring each pair of variables to have
...
;
; Must choose at least one color from the list and at most one color
...
;
; Match up at-least-one list for x and y 
; negate the clause formed from the corresponding pairs 
